...
abstract class Filter {
    ...
    abstract fun process(source: BufferedImage): BufferedImage
    ...
    override fun process(source: BufferedImage): BufferedImage {
        ...
        for (y in 0 until height) {
            for (x in 0 until width) {
                ...
                when {
                    gray < threshold -> out.setRGB(x, y, BLACK)
                    else -> out.setRGB(x, y, WHITE)
                }
            }
        }
    ...
    override fun process(source: BufferedImage): BufferedImage {
        ...
        for (y in 0 until height - 1) {
            for (x in 1 until width - 1) {
                ...
                val gray = source.getRGB(x, y) shr 16 and 0xFF
                var error: Int
